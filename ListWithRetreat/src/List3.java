...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        /*
         * Both preStart and postFinish are new nodes pointing to each other.
         */
        this.preStart = new Node();
        this.postFinish = new Node();

        /*
         * preStart's next points to postFinish, and postFinish's previous
         * points to preStart, making them point to each other.
         */
        ...
        /*
         * lastLeft is equal to preStart since there are no nodes in the left
         * string.
         */
        this.lastLeft = this.preStart;

        /*
         * The leftLength and rightLength equals 0 since there are no elements
         * in the left and right strings.
         */
        this.leftLength = 0;
        this.rightLength = 0;
    }
    ...
    public List3() {
        ...
        /*
         * Creates a new representation using createNewRep().
         */
        this.createNewRep();
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Creates a new node to add into the right string. The data of the new
         * node is equal to x, and the oldRight node is equal to the node next
         * to lastLeft, which is the current front of the right string.
         */
        ...
        /*
         * The newRight's previous points towards lastLeft, and the oldRight's
         * previous points to the newRight.
         */
        newRight.previous = this.lastLeft;
        oldRight.previous = newRight;

        /*
         * newRight's next is the oldRight, and the lastLeft node's next points
         * to newRight node.
         */
        ...
        /*
         * Increments rightLength to reflect the added node.
         */
        this.rightLength++;
        assert this.conventionHolds();
    }
    ...
    public final T removeRightFront() {
        ...
        /*
         * Creates a new node to remove from the right string. The data of the
         * new node is equal to answer, and the firstRight node is equal to the
         * node next to lastLeft. newRight node is equal to the node after
         * firstRight.
         */
        Node firstRight = this.lastLeft.next;
        Node newRight = firstRight.next;

        T answer = firstRight.data;

        /*
         * newRight's prevous points to lastLeft now.
         */
        newRight.previous = this.lastLeft;

        /*
         * lastLeft.next points to the newRight, after firstRight is removed.
         */
        this.lastLeft.next = newRight;

        /*
         * rightLength is decreased to reflect the removed node.
         */
        this.rightLength--;
    ...
    public final void advance() {
        ...
        /*
         * lastLeft points to the next node to move the "partition" to the right
         * by one space.
         */
        this.lastLeft = this.lastLeft.next;

        /*
         * increments leftLength and decrements rightLength to reflect the new
         * changes.
         */
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToStart() {
        ...
        /*
         * lastLeft is now equal to preStart to make all the nodes in the left
         * string move to the right string.
         */
        this.lastLeft = this.preStart;

        /*
         * Changes rightLength to reflect the changes, and sets leftLength to
         * nothing.
         */
    ...
    public final int leftLength() {
        ...
        /*
         * Sets answer to the length of the left string and returns answer.
         */
        int answer = this.leftLength;
    ...
    public final int rightLength() {
        /*
         * Sets answer to the length of the right string and returns answer.
         */
        int answer = this.rightLength;
    ...
    public final void moveToFinish() {
        ...
        /*
         * lastLeft is now equal to node before postFinish to make all the nodes
         * in the right string move to the left string.
         */
        this.lastLeft = this.postFinish.previous;

        /*
         * Changes leftLength to reflect the changes, and sets rightLength to
         * nothing.
         */
    ...
    public final void retreat() {
        ...
        /*
         * lastLeft points to the node before itself to move the "partition" to
         * the left by one space.
         */
        this.lastLeft = this.lastLeft.previous;

        /*
         * Increments rightLength and decrements leftLength to reflect the new
         * changes.
         */
        this.leftLength--;
        this.rightLength++;
